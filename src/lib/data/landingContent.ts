...
const KEY_IDEA_POOL: KeyIdea[] = [
  {
    ...
    body: "প্রতিদিনের ছোট ছোট সিদ্ধান্তগুলোই দীর্ঘমেয়াদে সবচেয়ে বড় পার্থক্য তৈরি করে — এই বইয়ে দেখানো হয়েছে কীভাবে সেগুলো চিনবেন।",
  },
  {
  ...
  },
  {
    ...
    body: "শুধু লক্ষ্য ঠিক করলেই হয় না — প্রতিদিন অনুসরণ করার মতো একটা সিস্টেম দরকার, যা এই বইয়ে ধাপে ধাপে দেখানো হয়েছে।",
  },
  {
...
export function getFaqs(product: Product): Faq[] {
  return product.category === "ebook" ? EBOOK_FAQS : BOOK_FAQS;
}
